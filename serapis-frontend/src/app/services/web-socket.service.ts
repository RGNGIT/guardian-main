...
import {MessageAPI} from "@app/enums/message";
import {ApplicationStates} from "@app/enums/application-states";
...
export class WebSocketService {
  ...
  public updateProfile() {
    this.send('UPDATE_PROFILE', this.userService.getAccessToken());
  }
